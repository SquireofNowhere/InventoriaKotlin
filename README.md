...
*   **Repeating Todos**: Schedule blocks can repeat daily or weekly, todos cannot. Let a todo repeat (daily, weekly, or some other interval) instead of being one-off — completing it should set up the next occurrence rather than the todo just being done forever.
