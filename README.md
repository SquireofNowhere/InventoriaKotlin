...
*   **Task History Display Toggle**: The Task History screen defaults to the session-grouped view, but a toggle in the top bar switches to a flat list of every individual completed segment ordered purely by start time, regardless of which session it belongs to. Persisted across app restarts.
